...
<head>
    ...
    <title>IQM - Edit Pengeluaran</title>
    <!-- Favicon icon -->
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="/pengeluaran/update">
                                @csrf
                                <div class="card-body">
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-group">
                                                ...
                                                <input type="number" id="harga" name="nominal" class="form-control" 
                                                    aria-label="Username" aria-describedby="basic-addon1" value="{{ $data['nominal']}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
