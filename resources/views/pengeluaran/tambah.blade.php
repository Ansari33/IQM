...
<head>
    ...
    <title>IQM - Tambah Pengeluaran</title>
    <!-- Favicon icon -->
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="/pengeluaran/simpan">
                                @csrf
                                <div class="card-body">
                                    <h4 class="card-title">Pengeluaran Info</h4>
                                    <div class="form-group row">
                                        <label for="fname"
                                            class="col-sm-2 text-end control-label col-form-label">Tanggal Pengeluaran</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-2  text-end control-label col-form-label">Pengeluaran</label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-group">
                                                ...
                                                <input type="number" id="harga" name="nominal" class="form-control"  required
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-2  text-end control-label col-form-label">Bukti </label>
                                        <div class="col-md-9">
                                            
                                        <input type="file" class="form-control" placeholder="Prepend"
                                            aria-label="Username" aria-describedby="basic-addon1" name="bukti" >
