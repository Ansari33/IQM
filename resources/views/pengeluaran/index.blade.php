                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="alert alert-success" role="alert">
                                ...
                                <p class="mb-0">Data Pengeluaran Berhasil {{ session('berhasil') }}.</p>
                            </div>
                            @elseif (session('gagal'))
                            <div class="alert alert-danger" role="alert">
                                <h4 class="alert-heading">Berhasil!</h4>
                                
                                <p class="mb-0">Data Pengeluaran Gagal {{ session('gagal') }}.</p>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-1">
                                        <a href="/pengeluaran/tambah" class="btn btn-success btn-sm text-white"><i class="fa fa-plus"> </i></a>
                                    </div>
                                </div>
                                    ...
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="/bukti-pengeluaran/{{ $item['bukti'] }}" type="button" class="btn btn-info btn-sm text-white"><i class="fa fa-download"></i> </a>
                                                </td>
                                                <td>
                                                    <a href="/pengeluaran/edit/{{ $item['id']}}" type="button" class="btn btn-cyan btn-sm text-white">Edit</a>
                                                    <a href="/pengeluaran/hapus/{{ $item['id'] }}" type="button" class="btn btn-danger btn-sm text-white" onclick=" return confirm('Yakin Menghapus Data?')">Hapus</a>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
   ...
   <script src="{{ asset('assets/libs/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js') }}"></script>
    <script>
        ...
        function exportExcel() {
            let aw =  $('#tgl-awal').val().toString().replaceAll('/','-');
            let ak =  $('#tgl-akhir').val().toString().replaceAll('/','-');
            console.log(aw,ak)
            if(aw != '' || ak != '' ){
                window.open(`/pengeluaran/export/${aw}/${ak}`)
            }else{
                window.open(`/pengeluaran/export`)
            }
           // window.open(`/pengeluaran/export/${aw}/${ak}`)
        }
        function exportPdf() {
