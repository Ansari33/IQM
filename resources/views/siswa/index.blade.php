                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-1">
                                        <a href="/siswa/tambah" class="btn btn-success btn-sm text-white"><i class="fa fa-plus"> </i></a>
                                        <a target="_blank" href="/siswa/export" class="btn btn-outline-success btn-sm "><i class="fa fa-download"> </i></a>
                                    </div>
                                </div>
                                    ...
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="/siswa/edit/{{ $item['uid']}}" type="button" class="btn btn-cyan btn-sm text-white">Edit</a>
                                                    
                                                    <a href="javascript:void(0)" type="button" class="btn btn-danger btn-sm text-white" onclick="return confirm('Hapus Data Siswa Ini?') ? window.location.href= '/siswa/hapus/{{ $item['uid'] }}' : false "  >Hapus</a>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
