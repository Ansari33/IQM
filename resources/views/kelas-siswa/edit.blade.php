...
<head>
    ...
    <title>IQM - Edit Kelas Siswa</title>
    <!-- Favicon icon -->
        ...
        <div class="page-wrapper">
                    ...
                    <div class="col-12 d-flex no-block align-items-center">
                        ...
                        <div class="ms-auto text-end">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="/kelas-siswa/{{$data['kelas_id']}}">Kelas Siswa</a></li>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="/kelas-siswa/update">
                                @csrf
                                <div class="card-body">
                                   
                                    
                                    <h4 class="card-title">Kelas Siswa Info</h4>
                                    <div class="form-group row">
                                        <label class="col-md-2  text-end control-label col-form-label">Kelas</label>
                                        <div class="col-md-9">
                                            <select class="select2 form-select shadow-none"
                                                style="width: 100%; height:36px;" name="kelas" required>
                                              
                                                <optgroup label="Pilih Kelas">
                                                    @foreach ($kelas as $item)
                                                    <option value="{{ $item['id']}}" @if ($data['kelas_id'] == $item['id'])
                                                        selected
                                                    @endif> {{ $item['nama'] == null ? ' ' : $item['nama'].' - '. $item['tahun']}} </option> 
                                                    @endforeach  
                                                </optgroup>
                                        ...
                                        <div class="col-md-9">
                                            <select class="select2 form-select shadow-none"
                                                ...
                                                <optgroup label="Pilih Siswa">
                                                    <option value="{{ $data['siswa_id']}}" selected> {{ $data['siswa']['nama'] == null ? ' ' : $data['siswa']['nama'] }} </option> 
