...
<head>
    ...
    <title>IQM - Tambah Kelas Siswa</title>
    <!-- Favicon icon -->
        ...
        <div class="page-wrapper">
                    ...
                    <div class="col-12 d-flex no-block align-items-center">
                        ...
                        <div class="ms-auto text-end">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="/kelas-siswa/{{$id}}">Kelas Siswa</a></li>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="/kelas-siswa/simpan">
                                @csrf
                                <div class="card-body">
