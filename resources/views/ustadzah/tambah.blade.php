...
<head>
    ...
    <title>IQM - Tambah Ustadzah</title>
    <!-- Favicon icon -->
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="/ustadzah/simpan">
                                @csrf
                                <div class="card-body">
                                    <h4 class="card-title">Info Ustadzah</h4>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <select class="select2 form-select shadow-none"
                                                style="width: 100%; height:36px;" name="pendidikan_akhir">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-2  text-end control-label col-form-label">Foto (jpg, png, jpeg)</label>
                                        <div class="col-md-9">  
                                            <input type="file" class="form-control" id="fname"
