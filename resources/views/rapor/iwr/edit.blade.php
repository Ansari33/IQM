...
<head>
    ...
    <title>IQM - Edit Rapor IWR</title>
    <!-- Favicon icon -->
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="/rapor/iwr/update">
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="jilid" value="{{ $data['jilid'] }}"> 
                                        </div>
                                    </div>
                                    <div class="form-group row">
