...
<head>
    ...
    <title>IQM - Edit Rapor Tahfidz</title>
    <!-- Favicon icon -->
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Edit Rapor Tahfidz</h4>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="/rapor/tahfidz/update">
                                @csrf
                                <input type="hidden" class="form-control" name="id" value="{{ $siswa['id'] }}"/>
                                <div class="card-body">
                                    <h4 class="card-title">Rapor Tahfidz Info</h4>
                                    <div class="form-group row">
                                        <label class="col-md-2  text-end control-label col-form-label">Siswa</label>
                                        <div class="col-md-9">
                                            <select class="select2 form-select shadow-none"
                                                style="width: 100%; height:36px;" name="siswa" disabled>
                                                ...
                                                <table class="table table-bordered">
                                                    <thead class="thead-light">
                                                        <tr>
                                                            ...
                                                            <th scope="col" colspan="">Nama Akses</th>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th>
                                                                <label class="customcheckbox">
                                                                    <input type="number" class="form-control" name="nilai[{{ $aks['id']}}]" value="{{ isset($data[$aks['id']]) ? $data[$aks['id']] : 0  }}"/>
