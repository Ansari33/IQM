                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="row">
                                            <div class="col-3">
                                                <a href="/rapor/tahfidz">
                                                    <div class="bg-success p-10 text-white text-center">
                                                        <i class="mdi mdi-file-document-box mb-2 font-16"></i>
                                                        <h5 class="mb-2 mt-1">Rapor Tahfidz</h5>
                                                        <small class="font-light">Nilai Tahfidz Siswa</small>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="col-3">
                                                <a href="/rapor/indikator-tahfidz">
                                                <div class="bg-cyan p-10 text-white text-center">
                                                    <i class="mdi mdi-settings mb-2 font-16"></i>
                                                    <h5 class="mb-2 mt-1">Indikator Tahfidz</h5>
                                                    <small class="font-light">Iidikator Penilaian Tahfidz</small>
                                                </div>
                                                </a>
                                            </div>
                                            <div class="col-3">
                                                ...
                                                <div class="bg-success p-10 text-white text-center">
                                                    <i class="mdi mdi-file-document-box mb-2 font-16"></i>
                                                    <h5 class="mb-2 mt-1">Rapor Kelas</h5>
                                                    <small class="font-light">Nilai Siswa</small>
                                                </div>
                                            </a>
                                            </div>
                                            <div class="col-3">
                                                <a href="/rapor/indikator-kelas">
                                                <div class="bg-cyan p-10 text-white text-center">
                                                    <i class="mdi mdi-settings mb-2 font-16"></i>
                                                    <h5 class="mb-2 mt-1">Indikator Kelas</h5>
                                                    <small class="font-light">Indikator Penilaian Nilai Kelas</small>
                                                </div>
                                                </a>
                                            </div>
                                        </div>
