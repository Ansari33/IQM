...
<head>
    ...
    <title>IQM - Tambah Dokumen</title>
    <!-- Favicon icon -->
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Tambah Data Dokumen</h4>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="/dokumen/simpan">
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <input type="file" class="form-control" placeholder="Prepend"
                                            aria-label="Username" aria-describedby="basic-addon1" name="dokumen" required>
