...
<head>
    ...
    <title>IQM - Histori Keuangan</title>
    <!-- Favicon icon -->
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Histori Keuangan</h4>
                        <div class="ms-auto text-end">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="/dashboard">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Histori Keuangan</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-1">
                                        ...
                                        <a href="/histori-uang/export" class="btn btn-success btn-sm text-white"><i class="fa fa-file"> </i></a> 
                                    </div>
                                </div>
{{-- 
                                <div class="row ml-3">
                                    ...
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td> {{ $item->tanggal }} </td>
                                                <td> {{ ucwords($item->sumber) }} </td>
                                                <td> {{ $item->keterangan }} </td>
                                                <td> {{ number_format($item->nominal)  }} </td>
                                                <td> {{ number_format($item->sumber == 'pengeluaran' ? $saldo -= $item->nominal : $saldo += $item->nominal )}} </td>
                                                <td>
                                                    
                                                    <a href="#" type="button" class="btn btn-outline-info btn-sm ">cek</a>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
