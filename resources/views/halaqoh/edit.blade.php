        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="/user-menu/update">
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">  
                                            <input  class="form-control" id="fname"
                                                placeholder="" name="username" value="{{ $data['username'] }}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-2  text-end control-label col-form-label">Password</label>
                                        <div class="col-md-9">  
