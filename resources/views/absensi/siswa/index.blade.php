                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row mb-3">
                                    <div class="col-lg-11">
                                        <h5 class="card-title">Data Absensi Siswa</h5>
                                    </div>
                                    <div class="col-lg-1">
                                        <a href="/absensi/siswa/harian" class="btn btn-success btn-sm text-white"><i class="fa fa-check"> </i></a>
                                    </div>
                                </div>
                                    ...
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td> {{$item['siswa'] == null ? 'Siswa Tidak Ditemukan' : $item['siswa']['nis'] }} </td>
                                                <td> 
                                                    @if($item['siswa'] !== null)
