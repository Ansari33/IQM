...
<head>
    ...
    <title>IQM - Absen Harian Guru</title>
    <!-- Favicon icon -->
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="/absensi/guru/update-harian">
                                @csrf
                                <div class="card-body">
                                                ...
                                                <table class="table table-bordered">
                                                    ...
                                                    <tbody class="customtable">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th>
                                                                <input type="time" class="form-control" name="jam[{{$aks['id']}}]"  style="width: 100px;"/>
                                                            </th>
                                                            <th>
                                                                <label class="customcheckbox">
