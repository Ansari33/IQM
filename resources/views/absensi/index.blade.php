                                    ...
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td> {{$item['siswa'] == null ? 'Kelas Tidak Ditemukan' : $item['siswa']['nama'] }} </td>
                                                <td> {{ $item['siswa']['kelas_siswa'] == null ? 'Kelas Tidak Ditemukan' : $item['siswa']['kelas_siswa']['kelas']['nama'] .' - '$item['siswa']['kelas']['nama'] }} </td>
                                                <td> 
