        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Tambah Data Pemasukkan</h4>
                        <div class="ms-auto text-end">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="/pemasukkan">Pemasukkan</a></li>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="/pemasukkan/simpan">
                                @csrf
                                <div class="card-body">
                                    <h4 class="card-title">Pemasukkan Info</h4>
                                    <div class="form-group row">
                                        <label for="fname"
                                            class="col-sm-2 text-end control-label col-form-label">Tanggal Pemasukkan</label>
                                        <div class="col-sm-9">
                                    ...
                                    {{-- <div class="form-group row">
                                        <label class="col-md-2  text-end control-label col-form-label">Stok Yang Dijual</label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-2  text-end control-label col-form-label">Pemasukkan</label>
                                        <div class="col-md-9">
                                            <input  name="nama" id="jumlah"  class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-group">
                                                ...
                                                <input type="number" id="harga" name="nominal" class="form-control"
                                                    aria-label="Username" aria-describedby="basic-addon1" onkeyup="hitungTotal()">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <textarea   cols="30" class="form-control" name="keterangan"></textarea>
                                        </div>
                                    </div>
                                </div>
