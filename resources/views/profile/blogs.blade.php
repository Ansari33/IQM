...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-xxl py-5" id="classes">
            <div class="container">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                    <h1 class="mb-3">Blog Kegiatan</h1>
        ...
        @foreach($data as $item => $it)
        <div class="container-xxl py-1">
            <div class="container">
                
                <div class="bg-light rounded">
                    <div class="row g-0">
                        <div class="col-lg-4 wow fadeIn" data-wow-delay="0.1s" style="min-height: 250px;">
                            <div class="position-relative h-100">
                                <img class="position-absolute w-100 h-100 rounded"
                                    src="{{ asset('gambar-blog/'.$it['gambar']) }}" style="object-fit: fill;">
                            </div>
                        </div>
                        <div class="col-lg-8 wow fadeIn" data-wow-delay="0.5s">
                            <div class="h-100 d-flex flex-column justify-content-center p-5">
                                <a href="blogs/view/{{ $it['judul'] }}"><h4 class="mb-4">{{ $it['judul'] }}</h4></a> 
                                <p class="mb-4">
                                </p>
