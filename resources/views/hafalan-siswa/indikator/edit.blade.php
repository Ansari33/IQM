...
<head>
    ...
    <title>IQM - Edit Indikator Tasmi'</title>
    <!-- Favicon icon -->
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Edit Data Indikator</h4>
                        <div class="ms-auto text-end">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="/tasmi/indikator">Indikator Tasmi'</a></li>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="/tasmi/indikator/update">
                                @csrf
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="number" class="form-control" id="fname"
                                                    placeholder="" name="urutan" value="{{ $data['urutan'] }}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="fname"
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <div class="row" id="row-child">
                                                    ...
                                                    @foreach($child as $chld => $ch)
                                                    @php
                                                    $uid = \Str::random(6);
                                                    @endphp
                                                    <div class="form-group row mt-2" id="id-{{ $uid }}"> 
                                                        <div class="col-sm-5">
                                                            <input class="form-control" id="fname" value="{{ $ch['keterangan'] }}"
                                                        ...
                                                        <div class="col-sm-2">
                                                            <input type="number" class="form-control" id="fname" value="{{ $ch['awal'] }}"
                                                        ...
                                                        <div class="col-sm-2">
                                                            <input type="number" class="form-control" id="fname" value="{{ $ch['akhir'] }}"
