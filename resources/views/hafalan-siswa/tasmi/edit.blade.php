...
<head>
    ...
    <title>IQM - Edit Rapor Tasmi'</title>
    <!-- Favicon icon -->
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Edit Nilai Tasmi'</h4>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="/tasmi/update">
                                @csrf
                                <div class="card-body">
                                    <h4 class="card-title">Info Nilai Tasmi'</h4>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group">
                                                <input type="text" name="tanggal" class="form-control mydatepicker" placeholder="mm/dd/yyyy" autocomplete="false" value="{{ \Carbon\Carbon::parse($data['tanggal'])->format('m/d/Y') }}" >
                                                    ...
                                                    <tbody class="customtable">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th>
                                                                ...
                                                                @if(isset( $nilai[$aks['nama']]))
                                                                <input type="hidden" name="ket[{{$aks['nama']}}]" id="keterangan-{{$aks['id']}}" value="{{ $nilai[$aks['nama']]['keterangan'] }}">
                                                                @else
                                                                ...
                                                                <select class="select2 form-select shadow-none"
                                                                    ...
                                                                    <optgroup label="Pilih Keterangan">
                                                                        ...
                                                                        @if(isset($nilai[$aks['nama']]))
                                                                        <option value="{{ $ind['awal'].'-'.$ind['akhir'] }}" @if($ind['keterangan'] == $nilai[$aks['nama']]['keterangan']) selected @endif > {{ $ind['keterangan'] }} </option>
                                                                        @else
                                                            ...
                                                            <th>
                                                                    ...
                                                                    <optgroup label="Pilih Nilai">
                                                                        @if(isset($nilai[$aks['nama']]))
                                                                        <option value="{{ $nilai[$aks['nama']]['nilai'] }}"> {{ $nilai[$aks['nama']]['nilai'] }} </option>
                                                                        @else
